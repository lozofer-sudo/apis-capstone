...
LLM	Deterministic logic (emulated)	Gemini 2.5 Flash/Pro
...
•	Insurance Cost Deviation — Metric: current insurance amount versus historical median. Threshold: >103% of median. Historical calculations use the actual purchase quantity (not a hardcoded value) to ensure fair comparison. Code: Section 5.
•	Tax Variation — Metric: current tax amount versus historical median. Threshold: >103% of median. Historical calculations use the actual purchase quantity (not a hardcoded value) to ensure fair comparison. Code: Section 5.
